...
Lorsque j'ai essayé de lancer mon code sur baobab, cela ne fonctionnait pas et j'avais ce message d'erreur:
#+begin_src sh
error while loading shared libraries: libmpi_cxx.so.40: cannot open shared object file: No such file or directory
srun: error: cpu001: task 0: Exited with exit code 127
#+end_src

Pour pallier à ce problème, j'ai dû
