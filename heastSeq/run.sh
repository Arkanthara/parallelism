...
#SBATCH --ntasks 4                    # Number of tasks in our job
...
if [ -n "$1" ]; then
	srun --mpi=pmi2 ./tp3 $1 1
	srun --mpi=pmi2 ./tp3 $1 10
	srun --mpi=pmi2 ./tp3 $1 100
	srun --mpi=pmi2 ./tp3 $1 1000
	srun --mpi=pmi2 ./tp3 $1 10000
	srun --mpi=pmi2 ./tp3 $1 100000
else
